...
class NewCRFDepth(nn.Module):
    ...
    def __init__(self, version=None, inv_depth=False, pretrained=None,
        ...
        ###
        # self.disp_head2 = DispHead2(input_dim=crf_dims[0])
        ...
        #                         padding=(0, 1))  # 16
        self.conv11 = nn.Conv2d(in_channels=1, out_channels=1, kernel_size=(8, 1), stride=(1, 1),  # 32, 64
                                padding=(0, 0))  # 16
    ...
    def forward(self, imgs):
        ...
        ppm_out = self.decoder(feats)  #bz,512,4,8
...
class DispHead3(nn.Module):
    def __init__(self, input_dim=100):
        ...
        # self.norm1 = nn.BatchNorm2d(input_dim)
        self.conv1 = nn.Conv2d(input_dim, 18, 3, padding=1) #input_dim
        # self.relu = nn.ReLU(inplace=True)
        self.sigmoid = nn.Sigmoid()
