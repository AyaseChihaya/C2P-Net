...
% load /home/zwd/work/geolayout/dataset/Matterport3D_Layout/validation.mat
load /home/ps/data/Z/zz_attention/dataset/matterport_layout/testing/testing(test)/testing.mat

% load result_mp_v21
% load result_z0_mp3d_v0
load result(9-12KD)
% load result_4.8_matterport

seg_path = '/home/ps/data/Z/zz_attention/dataset/matterport_layout/testing/testing/layout_seg/';
...
%         pred_3d(:,3) = pred_3d(:,3) * yy(i);
        ...
        intrinsics_matrix = 500 * data(i).intrinsics_matrix;
