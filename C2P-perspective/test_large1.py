...
def test(test_loader, model, thre):
    ...
    for i, sample_batched in enumerate(test_loader):
        ...
        # image_list_path = sorted(glob.glob(os.path.join('/home/ubuntu/work/geolayout/dataset/Matterport3D_Layout/testing/image/', '*.jpg')))
        # image_name = image_list_path[i].split('/')[-1][:-4]
        #
        #
        # save_name = r'/home/ubuntu/work/regiongrow/predict_param/train_inpaint(1-17-1)/'+image_name+'.mat'
