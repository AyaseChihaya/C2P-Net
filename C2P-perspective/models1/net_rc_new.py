...
# import resnet
# import densenet
from models import modules_rc_new, resnet, densenet, senet
...
class model(nn.Module):
    def __init__(self, Encoder, num_features, block_channel):
        ...
        self.E = Encoder
        self.D = modules_rc_new.D(num_features)
        self.MFF = modules_rc_new.MFF(block_channel)
        self.R_PARAM = modules_rc_new.R_PARAM(block_channel)

        self.C = modules_rc_new.C(block_channel)
        self.R_LOC = modules_rc_new.R_LOC(block_channel)

        self.D_MASK = modules_rc_new.D_MASK(num_features)
        self.R_MASK = modules_rc_new.R_MASK(block_channel)

        self.D_PLANE = modules_rc_new.D_PLANE(num_features)
        self.R_PLANE = modules_rc_new.R_PLANE(block_channel)    
