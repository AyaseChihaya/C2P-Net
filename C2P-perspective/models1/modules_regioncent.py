...
class E_densenet(nn.Module):
    ...
    def forward(self, x):
        ...
        x_block1 = self.features[4](x04)    # checkpoint = torch.load('model_regioncent_v1.pth.tar')
...
class R(nn.Module):
    def __init__(self, block_channel):
        ...
        self.conv2 = nn.Conv2d(
            num_features, 7, kernel_size=5, stride=1, padding=2, bias=True)
