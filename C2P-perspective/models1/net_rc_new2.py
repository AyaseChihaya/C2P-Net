...
# import resnet
# import densenet
from models import modules_rc_new2, resnet, densenet, senet
...
class model(nn.Module):
    def __init__(self, Encoder, num_features, block_channel):
        ...
        self.E = Encoder
        self.D = modules_rc_new2.D(num_features)
        self.MFF = modules_rc_new2.MFF(block_channel)
        # self.R_PARAM = modules_rc_new.R_PARAM(block_channel)
        self.R = modules_rc_new2.R(block_channel)

        self.C = modules_rc_new2.C(block_channel)
        self.R_LOC = modules_rc_new2.R_LOC(block_channel)

        self.D_MASK = modules_rc_new2.D_MASK(num_features)
        self.R_MASK = modules_rc_new2.R_MASK(block_channel)

        self.D_PLANE = modules_rc_new2.D_PLANE(num_features)
        self.R_PLANE = modules_rc_new2.R_PLANE(block_channel)
