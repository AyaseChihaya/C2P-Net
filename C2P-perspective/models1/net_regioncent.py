...
# import resnet
# import densenet
from models import modules_regioncent, resnet, densenet, senet
...
class model(nn.Module):
    def __init__(self, Encoder, num_features, block_channel):
        ...
        self.E = Encoder
        self.D = modules_regioncent.D(num_features)
        self.MFF = modules_regioncent.MFF(block_channel)
        self.R = modules_regioncent.R(block_channel)
