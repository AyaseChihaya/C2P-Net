...
class D(nn.Module):
    ...
    def __init__(self, num_features = 2048):
        ...
        #     num_input_features=128, num_output_features=2)
        # num_features = num_features // 2
    ...
    def forward(self, x_block1, x_block2, x_block3, x_block4):
        ...
        # embedding = self.up5(x_d3, [x_block1.size(2)*2, x_block1.size(3)*2])
...
class R(nn.Module):
    def __init__(self, block_channel):
        ...
        num_features = 66 + block_channel[3]//32
        ...
        self.conv2 = nn.Conv2d(
            num_features, 8, kernel_size=5, stride=1, padding=2, bias=True)
...
class R1(nn.Module):
    def __init__(self, block_channel):
        ...
        num_features = 69 + block_channel[3]//32
        self.conv0 = nn.Conv2d(num_features, num_features,
                               kernel_size=5, stride=1, padding=2, bias=False)
        self.bn0 = nn.BatchNorm2d(num_features)
...
class R2(nn.Module):
    def __init__(self, block_channel):
        ...
        self.conv2 = nn.Conv2d(
            num_features, 2, kernel_size=5, stride=1, padding=2, bias=True)
...
class DEP(nn.Module):
    def __init__(self, block_channel):
        ...
        # self.conv3 = nn.Conv2d(1, 64, kernel_size=5, stride=1, padding=2, bias=False)
        # self.bn3 = nn.BatchNorm2d(64)
        #
        # self.conv4 = nn.Conv2d(64, 1, kernel_size=5, stride=1, padding=2, bias=True)
