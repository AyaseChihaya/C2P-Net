...
class D(nn.Module):
    ...
    def __init__(self, num_features = 2048):
        ...
        self.up4 = _UpProjection(
            num_input_features=num_features, num_output_features=10)
        num_features = num_features // 2
...
#             num_features, 10, kernel_size=5, stride=1, padding=2, bias=True)
#
#     def forward(self, x):
#         x0 = self.conv0(x)
#         x0 = self.bn0(x0)
...
#
#         self.conv0 = nn.Conv2d(2048, 1024, (3, 3), stride=1, padding=0)
#         self.conv1 = nn.Conv2d(1024, 512, (5, 5), stride=1, padding=0)
#         self.conv2 = nn.Conv2d(512, 4, (1, 1), stride=1, padding=0)
#
#     def forward(self, x):
