...
# import resnet
# import densenet
from models import modules_convnext, resnet, densenet, senet
...
class model(nn.Module):
    def __init__(self, Encoder, num_features, block_channel):
        ...
        self.E = Encoder
        self.D = modules_convnext.D(num_features)
        self.MFF = modules_convnext.MFF(block_channel)
        self.R = modules_convnext.R(block_channel)

        self.C = modules_convnext.C(block_channel)
        self.R_LOC = modules_convnext.R_LOC(block_channel)

        self.D_MASK = modules_convnext.D_MASK(num_features)
        self.R_MASK = modules_convnext.R_MASK(block_channel)

        self.D_PLANE = modules_convnext.D_PLANE(num_features)
        self.R_PLANE = modules_convnext.R_PLANE(block_channel)
