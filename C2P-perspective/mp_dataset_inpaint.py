...
class ImageDataset(Dataset):
    ...
    def __init__(self, transform_matterport=None):
        ...
        self.lsun_img_name = sorted(glob.glob(os.path.join('/home/ps/data/Z/dataset(2Dmatter)/matterport_layout/training/image/', '*.jpg')))
        self.lsun_seg_name = sorted(glob.glob(os.path.join('/home/ps/data/Z/dataset(2Dmatter)/matterport_layout/training/layout_seg/', '*.png')))
        self.lsun_depth_name = sorted(glob.glob(os.path.join('/home/ps/data/Z/dataset(2Dmatter)/matterport_layout/training/layout_depth/', '*.png')))
        self.lsun_raw_depth_name = sorted(glob.glob(os.path.join('/home/ps/data/Z/dataset(2Dmatter)/matterport_layout/training/depth/', '*.png')))
