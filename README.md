...
# Code
C2P-panoramic: Folder for panoramic images

Pretrained model: pretrained_model/swin_large_patch4_window7_224_22k.pth

Trained model: trained_model

test.py is the testing script

test.m is the post-processing script

C2P-perspective: Folder for perspective images

test_large1.py is the testing script

Trained model: trained_model

mp3d_visio.m is the post-processing script
